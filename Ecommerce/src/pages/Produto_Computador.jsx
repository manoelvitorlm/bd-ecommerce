...
function Produto_Computador() {

  var title = "Computador";
  var id = "COMGENX";
  var preco = "1899,90";
  var img = "/assets/images/computador-comprar.jpg";
  var descricao = "Computador completo com monitor, mouse, teclado e caixa de som.";
  var qtd_estoque = "889"
...
export default Produto_Computador;
