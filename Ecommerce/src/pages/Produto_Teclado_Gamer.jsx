...
function Produto_Teclado_Gamer() {

    var title = "Teclado Gamer";
    var id = "TEGGENX";
    var preco = "329,00";
    var img = "./assets/images/teclado-gamer-comprar.jpg";
        ...
        <div>
            ...
            <main>
                ...
                <section className="container produtos">
                    ...
                    <BreadCrumb categoria="Teclados Gamer" />
                    ...
                    <article className="row produtos-compra">
                        ...
                        <div className="fb-comments col-md-12 mt-5 mb-5" data-href="http://127.0.0.1:3000/produto-teclado-gamer" 
                            data-width="100%" data-numposts="5"></div>

                        <div className="fb-share-button" data-href="http://127.0.0.1:3000/Ecommerce/produto-teclado-gamer" 
...
export default Produto_Teclado_Gamer;
