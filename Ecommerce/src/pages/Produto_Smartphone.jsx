...
function Produto_Smartphone() {

    var title = "Smartphone";
    var id = "SMAGENX";
    var preco = "1499,00";
    var img = "./assets/images/smartphone-comprar.jpg";
            ...
            <main>
                ...
                <section className="container produtos">
                    ...
                    <article className="row produtos-compra">
                        ...
                        <div className="fb-comments col-md-12 mt-5 mb-5" data-href="http://127.0.0.1:3000/produto-smartphone" 
                            data-width="100%" data-numposts="5"></div>

                        <div className="fb-share-button" data-href="http://127.0.0.1:3000/Ecommerce/produto-computador?#" 
...
export default Produto_Smartphone;
