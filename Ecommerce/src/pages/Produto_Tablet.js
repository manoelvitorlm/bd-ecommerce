...
function Produto_Tablet() { 

    var title = "Tablet";
    var id = "TABGENX";
    var preco = "799,00";
    var img = "./assets/images/tablet-comprar.jpg";
            ...
            <main>
                ...
                <section className="container produtos">
                    ...
                    <article className="row produtos-compra">
                        ...
                        <div className="fb-comments" data-href="http://127.0.0.1:3000/produto-tablet" data-width="100%" data-numposts="5"></div>

                        <div className="fb-share-button" data-href="http://127.0.0.1:3000/produto-tablet " 
